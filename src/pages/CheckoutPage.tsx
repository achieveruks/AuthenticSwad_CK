    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5 sm:p-6 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-gray-600 bg-gray-50 rounded-xl p-3.5 border border-gray-200">
            <div>
              <p className="font-bold text-gray-900 mb-1">Delivering To:</p>
              <p className="font-semibold text-gray-800">{placedOrder.customerDetails.fullName}</p>
            ...
            <div>
              <p className="font-bold text-gray-900 mb-1">Payment & Slot:</p>
